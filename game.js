...
(function() {
  var Beam, Droid, Fighter, Invader, Laser,
  ...
  Invader = (function(_super) {
    ...
    Invader.prototype.addLaser = function() {
      var lsr, pointer;
      if (this.cnt_laser < this.config.MAXLASER) {
        pointer = Math.floor(Math.random() * 50);
        if (this.enemy[pointer] != null) {
          lsr = new Laser(this.enemy[pointer].x + 14, this.enemy[pointer].y + 16, this.fighter);
          this.rootScene.addChild(lsr);
          this.cnt_laser += 1;
          return console.log("addLaser @cnt_laser:" + this.cnt_laser);
        }
      }
    };

    Invader.prototype.removeLaser = function() {
      this.cnt_laser -= 1;
      return console.log("removeLaser @cnt_laser:" + this.cnt_laser);
    };
  ...
  Laser = (function(_super) {
    ...
    function Laser(x, y, fighter) {
      Laser.__super__.constructor.call(this, 4, 16);
      this.game = enchant.Game.instance;
      this.fighter = fighter;
      this.image = this.game.assets["image/laser.png"];
      this.x = x;
      this.y = y;
      this._style.zIndex = 1;
      this.addEventListener('enterframe', function() {
    ...
    Laser.prototype.update = function() {
      ...
      if (this.intersect(this.fighter)) {
        this.game.rootScene.backgroundColor = "red";
        this.game.stop();
